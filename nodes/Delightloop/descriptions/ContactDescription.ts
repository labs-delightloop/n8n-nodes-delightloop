...
export const contactFields: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description:
          'Array of tag objects with <code>name</code> (required) and optional <code>color</code> (hex). Example: <code>[{"name":"vip","color":"#FF5733"}]</code>',
      },
    ],
  },
  ...
  // ─────────────────────────── BULK CREATE ───────────────────────────
  {
    ...
    description:
      "Array of contact objects. Each must have at least an <code>email</code>. Optional fields: firstName, lastName, companyName, jobTitle, phone, linkedinUrl.",
  },
